...
global $auth_conn,$auth_table,$config_array,$config_name,$email_displayFrom,$email_displayName,$email_sendFrom,$enable_table_minimum,$enable_table_num,$full_path,$full_url,$res_6pm_ooh,$res_8pm_ooh,$res_table,$tab_1_name,$tab_2_name,$tab_3_name,$tab_4_name,$tab_5_name,$tab_6_name,$theme_color,$theme_color_secondary,$theme_logo;

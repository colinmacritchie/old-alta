...
{include file="header.tpl" theme_color = {$theme_color} full_url = {$full_url} res_lunch_class="active" House_Adults_Total = {$House_Adults_Total} House_Children_Total = {$House_Children_Total} House_Party_Total = {$House_Party_Total} Lodge_Adults_Total = {$Lodge_Adults_Total} Lodge_Children_Total = {$Lodge_Children_Total}}

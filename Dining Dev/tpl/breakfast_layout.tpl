...
{include file="header.tpl" theme_color = {$theme_color} full_url = {$full_url} res_breakfast_class="active" House_Adults_Total = {$House_Adults_Total} House_Children_Total = {$House_Children_Total} House_Party_Total = {$House_Party_Total} Lodge_Adults_Total = {$Lodge_Adults_Total} Lodge_Children_Total = {$Lodge_Children_Total}}
                									...
                									<div class="row">
                    									<div class="col-md-12">
        													<select name="res_num" class="guestselectclasses" required>
																...
																{section name=guests loop=$Guestlist}
                												<option class="option-formatting" value="{$Guestlist[guests].ResNumNumeric}, {$Guestlist[guests].People1 + $Guestlist[guests].People2 + $Guestlist[guests].People3 + $Guestlist[guests].People4}" data-food="{$Guestlist[guests].Comment8}" data-special="" data-affiliation="{$Guestlist[guests].Comment7}">{$Guestlist[guests].RoomNum} - {$Guestlist[guests].GuestName} ({$Guestlist[guests].People1 + $Guestlist[guests].People2 + $Guestlist[guests].People3 + $Guestlist[guests].People4})
